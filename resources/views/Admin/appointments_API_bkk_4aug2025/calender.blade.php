...
<?php
$sched_res = [];
foreach($appointments['data'] as $appointment){ //dd($appointment);
    ...
    if(strtotime($datetimes) >= strtotime($curtime)){
        ...
        $row['name'] = $appointment['client']['name'] ? base64_encode($appointment['client']['name']) : base64_encode('NA');
        ...
        */
        ...
        $row['full_name'] = $appointment['client']['name'] ? trim(($appointment['client']['name'] ?? '') ) : 'NA';
        ...
        if( isset($appointment['service_id']) && $appointment['service_id'] != "" ) {
            ...
            if( isset($appointment['service']['title']) && $appointment['service']['title'] != ''  ){
                if( $appointment['service']['price'] == 'Free') {
