...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="{{ url('admin/tax/edit') }}" name="add-visatype" autocomplete="off" enctype="multipart/form-data" method="POST">
				@csrf
											...
											<div class="row"> 						
												...
												<div class="col-12 col-md-4 col-lg-4">
													<div class="form-group"> 
														...
														<input type="number" name="amount" class="form-control" data-valid="required" value="{{ old('amount', @$fetchedData->amount) }}">
														@if ($errors->has('name'))
															<span class="custom-error" role="alert">
																<strong>{{ @$errors->first('name') }}</strong>
															</span> 
