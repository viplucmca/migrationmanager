...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			<form action="{{ url('admin/visa-type/edit') }}" name="edit-visatype" autocomplete="off" enctype="multipart/form-data" method="POST">
				@csrf
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group float-right">
									<button type="submit" class="btn btn-primary">Update Visa Type</button>
								</div>
							</div>
						</div>
					</div>
