                ...
                <div class="content-grid">
                    ...
                    <div class="card">
                        <div class="qualification-section">
                            ...
                            <div class="qualification-list" style="max-height: 300px; overflow-y: auto;">
                    ...
                    <div class="card">
                        <div class="experience-section">
                            ...
                            <div class="experience-list" style="max-height: 300px; overflow-y: auto;">
                    ...
                    <div class="card">
                        <div class="eoi-section">
                            ...
                            <div class="eoi-list" style="max-height: 300px; overflow-y: auto;">
                ...
                <div class="card full-width notes-container">
                    ...
                    <div class="note_term_list subtab8-content">
                        ...
                        <div class="note-card-redesign <?php if($list->pin == 1) echo 'pinned'; ?>" data-matterid="{{ $list->matter_id }}" id="note_id_{{$list->id}}" data-type="{{ $typeLabel }}">
                            ...
                            <div class="note-content-redesign">{!! nl2br(e($descShort)) !!}
                                <?php if($showReadMore): ?>
                                    ...
                                    <div class="subtab2-pane <?= $isActive ?>" id="<?= $id ?>-subtab2">
                                        <div class="checklist-table-container" style="vertical-align: top; margin-top: 10px; width: 760px;">
                                            ...
                                            <table class="checklist-table">
                                                ...
                                                <tbody class="tdata documnetlist_<?= $id ?>">
                                                    <?php
...
<script>
    ...
    jQuery(document).ready(function($){
        ...
        $(document).delegate('#agreementUploadForm', 'submit', function(e) {
            e.preventDefault();
        ...
        $(document).on('click', '.migdocumnetlist1 .renamedoc', function () {
            var parent = $(this).closest('.drow').find('.doc-row');
            parent.data('current-html', parent.html());
            var opentime = parent.data('name');
            parent.empty().append(
        ...
        $(document).on('click', '.migdocumnetlist1 .drow .btn-danger', function () {
            var parent = $(this).closest('.drow').find('.doc-row');
            var hourid = parent.data('id');
            if (hourid) {
                parent.html(parent.data('current-html'));
        ...
        $(document).delegate('.migdocumnetlist1 .drow .btn-primary', 'click', function () {
            var parent = $(this).closest('.drow').find('.doc-row');
            parent.find('.opentime').removeClass('is-invalid');
            parent.find('.invalid-feedback').remove();
            var opentime = parent.find('.opentime').val();
        ...
        $(document).on('click', '.migdocumnetlist1 .renamechecklist', function () {
        ...
        $(document).on('click', '.migdocumnetlist1 .drow .btn-visadanger', function () {
            var parent = $(this).closest('.drow').find('.visachecklist-row');
            var hourid = parent.data('id');
            if (hourid) {
                parent.html(parent.data('current-html'));
        ...
        $(document).delegate('.migdocumnetlist1 .drow .btn-visaprimary', 'click', function () {
            var parent = $(this).closest('.drow').find('.visachecklist-row');
            parent.find('.opentime').removeClass('is-invalid');
            parent.find('.invalid-feedback').remove();
            var opentime = parent.find('.opentime').val();
