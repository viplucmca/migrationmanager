						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group"> 
								...
								<div class="input-group">
									...
									{!! html()->text('expect_start_date')->value('')->class('form-control datepicker')->attribute('data-valid', '')->attribute('autocomplete', 'off')->attribute('placeholder', 'Select Date') !!}
								</div>
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group"> 
								...
								<div class="input-group">
									...
									{!! html()->text('expect_win_date')->value('')->class('form-control datepicker')->attribute('data-valid', '')->attribute('autocomplete', 'off')->attribute('placeholder', 'Select Date') !!}
								</div> 
								<span class="span_note">Date must be in YYYY-MM-DD (2012-12-22) format.</span>
