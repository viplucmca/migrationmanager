	...
	<div class="col-md-3">
		<div class="cus_sidebar">
			<div class="form-group">
				...
				{!! html()->text('applied_intake', $fetchData->intakedate)->class('form-control')->attribute('data-valid', '')->attribute('autocomplete', 'off')->attribute('readonly', true) !!}
			...
			<div class="form-group">
				...
				{!! html()->text('expect_win_date', $fetchData->expect_win_date)->class('form-control')->attribute('data-valid', '')->attribute('autocomplete', 'off')->attribute('readonly', true) !!}
				<span class="span_note">Date must be in YYYY-MM-DD (2012-12-22) format.</span>
